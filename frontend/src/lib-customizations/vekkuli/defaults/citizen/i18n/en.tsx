    ...
    formPage: {
      ...
      info: {
        renew:
          ...
          'If you need a smaller space for the next season, change the spot first and pay the season fee only after the change.\n' +
          'If you need a larger space for the next season, pay the season fee first, then change the spot, and pay the additional fee for the larger spot.',
        switch:
  ...
  citizenPage: {
    ...
    reservation: {
      ...
      renewNotification: (date: LocalDate) =>
        `The contract period is ending. Secure the same spot for next season by paying the season fee by ${date.format()}.`,
      harbor: 'Harbor',
