...
dependencies {
    ...
    implementation("io.ktor:ktor-client-cio:3.4.1") // CIO engine
    implementation("io.ktor:ktor-client-content-negotiation:3.4.1") // Content negotiation
    implementation("io.ktor:ktor-serialization-kotlinx-json:3.4.1") // kotlinx serialization
