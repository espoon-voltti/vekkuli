...
dependencies {
    ...
    implementation("io.ktor:ktor-client-cio:3.4.0") // CIO engine
    implementation("io.ktor:ktor-client-content-negotiation:3.4.0") // Content negotiation
    implementation("io.ktor:ktor-serialization-kotlinx-json:3.4.0") // kotlinx serialization
    ...
    downloadOnly("com.datadoghq:dd-java-agent:1.58.1")
}
