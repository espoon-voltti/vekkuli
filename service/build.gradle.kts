...
dependencies {
    ...
    implementation(platform("org.jdbi:jdbi3-bom:3.52.1"))
    ...
    implementation("io.ktor:ktor-client-cio:3.4.2") // CIO engine
    implementation("io.ktor:ktor-client-content-negotiation:3.4.2") // Content negotiation
    implementation("io.ktor:ktor-serialization-kotlinx-json:3.4.2") // kotlinx serialization
    ...
    downloadOnly("com.datadoghq:dd-java-agent:1.61.1")
}
