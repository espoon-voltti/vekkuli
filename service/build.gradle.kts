...
// OWASP: override Spring Boot 4.1.0's managed versions to the CVE-patched releases.
// No Spring Boot 4.1.1 has shipped these yet; drop each override once a Spring Boot
...
dependencies {
    ...
    implementation("io.ktor:ktor-client-cio:3.5.2") // CIO engine
    implementation("io.ktor:ktor-client-content-negotiation:3.5.2") // Content negotiation
    implementation("io.ktor:ktor-serialization-kotlinx-json:3.5.2") // kotlinx serialization
    ...
    downloadOnly("com.datadoghq:dd-java-agent:1.65.0")
}
