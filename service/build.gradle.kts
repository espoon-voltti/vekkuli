...
dependencies {
    ...
    implementation("io.ktor:ktor-client-cio:3.3.1") // CIO engine
    implementation("io.ktor:ktor-client-content-negotiation:3.3.1") // Content negotiation
    implementation("io.ktor:ktor-serialization-kotlinx-json:3.3.1") // kotlinx serialization
    ...
    downloadOnly("com.datadoghq:dd-java-agent:1.54.0")
}
