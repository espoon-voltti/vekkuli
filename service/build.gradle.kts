...
dependencies {
    ...
    implementation("io.ktor:ktor-client-cio:3.1.3") // CIO engine
    implementation("io.ktor:ktor-client-content-negotiation:3.1.3") // Content negotiation
    implementation("io.ktor:ktor-serialization-kotlinx-json:3.1.3") // kotlinx serialization
    ...
    downloadOnly("com.datadoghq:dd-java-agent:1.49.0")
}
