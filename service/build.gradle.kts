...
dependencies {
    ...
    implementation("io.ktor:ktor-client-cio:3.5.0") // CIO engine
    ...
    // AWS dependencies
    implementation(platform("software.amazon.awssdk:bom:2.46.1"))
    ...
    downloadOnly("com.datadoghq:dd-java-agent:1.62.0")
}
