...
abstract class IntegrationTestBase {
    ...
    val citizenIdMarko: UUID = UUID.fromString("1128bd21-fbbc-4e9a-8658-dc2044a64a58")
    val espooCitizenWithoutReservationsId: UUID = citizenIdMikko
    val nonEspooCitizenWithoutReservationsId: UUID = citizenIdMarko
