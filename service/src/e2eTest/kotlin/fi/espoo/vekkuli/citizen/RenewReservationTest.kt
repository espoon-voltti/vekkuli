...
class RenewReservationTest : ReserveTest() {
    ...
    fun `should be able to renew slip reservation`() {
        ...
        assertThat(citizenDetailsPage.reservationListCards)
            .containsText("Laituripaikka: Haukilahti B 001")
    ...
    fun `should be able to renew slip reservation for organization`() {
        ...
        page.getByText("Espoon Pursiseura").click()
        assertThat(reservationSection.renewButton).isHidden()
        assertThat(citizenDetailsPage.reservationListCards.nth(0))
            .containsText("Laituripaikka: Haukilahti B 005")
    }
    ...
    fun `should be able to renew winter reservation`() {
        ...
        form.fillFormAndSubmit {
            ...
            getWinterStorageTypeSection().trailerRegistrationNumberInput.fill("ABC123")
        ...
        assertThat(citizenDetailsPage.reservationListCards)
            .containsText("Talvipaikka: Haukilahti B 013")
