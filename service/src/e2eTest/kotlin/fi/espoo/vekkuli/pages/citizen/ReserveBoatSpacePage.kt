...
class ReserveBoatSpacePage(
    ...
    class ElementLocator(private val locator: Locator) {
        fun getInput(label: String) = locator.locator("label")
            .getByText(label)
            .locator("..")
            .locator("input")

        fun getCheckbox(label: String) = locator.locator("label.checkbox span")
            .getByText(label, Locator.GetByTextOptions().setExact(true))
            .locator("..")
            .locator("input[type=checkbox]")

        fun getRadio(label: String) = locator.locator("label .body")
            .getByText(label, Locator.GetByTextOptions().setExact(true))
            .locator("..")
            .locator("..")
            .locator("input[type=radio]")

        fun getSelect(label: String) = locator.locator("label")
            .getByText(label, Locator.GetByTextOptions().setExact(true))
            .locator("..")
            .locator("select")
    }
