...
class ReservationFormController(
    ...
    fun boatSpaceApplicationFormForCitizen(
        ...
        request.getAuthenticatedUser()?.let {
            logger.audit(it, "GET_BOAT_SPACE_APPLICATION_FORM", mapOf("reservationId" to reservationId.toString()))
        }
    ...
    fun removeBoatSpaceReservationAsCitizen(
        ...
        request.getAuthenticatedUser()?.let {
            logger.audit(it, "REMOVE_BOAT_SPACE_RESERVATION", mapOf("reservationId" to reservationId.toString()))
        }
        val citizenId = request.ensureCitizenId()
    ...
    fun searchCitizens(
        ...
        request.getAuthenticatedUser()?.let {
            logger.audit(it, "SEARCH_CITIZENS", mapOf("reservationId" to reservationId.toString(), "nameParameter" to nameParameter))
        }
    ...
    fun searchCitizen(
        ...
        request.getAuthenticatedUser()?.let {
            logger.audit(it, "SEARCH_CITIZENS_RESULTS", mapOf("citizenId" to citizenIdOption.toString()))
        }
    ...
    fun boatFormCitizen(
        ...
        request.getAuthenticatedUser()?.let {
            logger.audit(it, "BOAT_FORM_CITIZEN", mapOf("reservationId" to reservationId.toString()))
        }
    ...
    fun boatFormEmployee(
        ...
        request.getAuthenticatedUser()?.let {
            logger.audit(it, "BOAT_FORM_EMPLOYEE", mapOf("reservationId" to reservationId.toString(), "citizenId" to citizenId.toString()))
        }
    ...
    fun reserveBoatSpaceForCitizen(
        ...
        request.getAuthenticatedUser()?.let {
            logger.audit(it, "RESERVE_BOAT_SPACE_CITIZEN", mapOf("reservationId" to reservationId.toString()))
        }
    ...
    fun reserveBoatSpaceForEmployee(
        ...
        request.getAuthenticatedUser()?.let {
            logger.audit(it, "RESERVE_BOAT_SPACE_EMPLOYEE", mapOf("reservationId" to reservationId.toString()))
        }
    ...
    fun reserveBoatSpaceByCitizen(
        ...
        request.getAuthenticatedUser()?.let {
            logger.audit(it, "INITIAL_BOAT_SPACE_RESERVATION", mapOf("spaceId" to spaceId.toString()))
        }
        val citizen = getCitizen(request, reserverService)
        if (citizen?.id == null) {
