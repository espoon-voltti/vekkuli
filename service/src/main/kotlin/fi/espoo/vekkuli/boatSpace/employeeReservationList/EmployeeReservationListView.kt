            ...
            <section class="section">
                ...
                <div class="container" x-data="{
                    ...
                    <form id="reservation-filter-form"
                          ...
                          hx-target="#reservation-filter-form"
                          hx-select="#reservation-filter-form"
                    ...
                    >
                        ...
                        <div class="employee-warning-filter">
                            <div>${warningFilter.render(params.warningFilter == true, reservations.totalWarnings)}</div>
                        ...
                        <div class="reservation-list form-section block">
                            ...
                            <div class="has-text-centered" x-data="{ 
